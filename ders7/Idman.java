...
public class Idman {
	...
	public void burpeeYap(int sayi) {
		...
		if (burpee_sayisi - sayi < 0 ) {
			System.out.println("Hedeflediðin burpee geçtin Tebrikler ! ");
			burpee_sayisi = 0;
	...
	public void pushupYap(int sayi) {
		...
		if (pushup_sayisi - sayi < 0 ) {
			System.out.println("Hedeflediðin pushup geçtin Tebrikler ! ");
			pushup_sayisi = 0;
...
public void situpYap(int sayi) {
	...
	if (pushup_sayisi - sayi < 0 ) {
		System.out.println("Hedeflediðin situp geçtin Tebrikler ! ");
		situp_sayisi = 0;
...
public void squatYap(int sayi) {
	...
	if (squat_sayisi - sayi < 0 ) {
		System.out.println("Hedeflediðin squat geçtin Tebrikler ! ");
		squat_sayisi = 0;
